            ...
            for (const dict_key in total_active_calls) {
                ...
                callers.forEach(element => {
                    ...
                    if (myDiv) {
                        ...
                        raw_html = `
                            <div ondblclick = 'set_note(this.id)' style = "background-color:${total_active_calls[dict_key]['background']}; color:${total_active_calls[dict_key]['font']};" class="container draggable_banner noselect room-banner" id="element-${element}">
                                <div class="text" id="${element}">${element}</div>
                                <div class="menu-wrap">
                                    <input type="checkbox" class="toggler">
                                    <div class="dots">
                                        <div></div>
                                    ...
                                    <div class="menu">
                                        <div>
                                            <ul>
                                                <li><a class="link myurl" id="${element}-url" href="${total_active_calls[dict_key]['url']}" target="_blank">Url</a></li>
                                                <li><a class="link" id = '${element}-click' onclick = "set_value(this.id)" >Colour</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
