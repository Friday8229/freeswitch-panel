...
if len(sys.argv) != 3:
    print "I WONT PROCEED"
    exit()
else:
    print "WORKED"
    
    extension = "{origination_caller_id_number=123456789,origination_caller_id_name=Admin}sofia/internal/" + sys.argv[1]  + "%" + host_ip
    mod_conf = "&conference(" + sys.argv[2] + ")"
    
    # extension = "sofia/external/916269106539@94.237.97.9:5060"
    # mod_conf = "&playback(/usr/share/freeswitch/sounds/music/default/8000/babyshark.wav)"
    
    # print extension, mod_conf
    # exit()
...
# result = yield client.make_call(
#             ext="sofia/internal/101%167.99.241.212",
#             context="&playback(/usr/share/freeswitch/sounds/music/default/8000/babyshark.wav)")